        ...
        <div class="center_prod_box_big">
            ...
            <div class="details_big_box">
                ...
                <div class="specifications"> Disponibilitate: <span class="blue">In stoc</span><br />
                    ...
                    Pretul include <span class="blue">TVA</span><br /><br/>
                    Details:<br/><c:forTokens items="${product.description}" delims=";" var="descript">
                        <span class="blue">${descript}<br/></span>
                    </c:forTokens>
                </div>
                <div class="prod_price_big"><b>Price: </b><span class="price">${product.price}$</span></div>
                <a href="./addedtocart/${product.id}" class="addtocart">add to cart</a> 
            </div>
        </div>
